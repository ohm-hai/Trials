"""Phase 7 tiny: megakernel-full vs production aiter.fused_moe at very small
decode batch sizes (1,2,4,8,12,16,32,64). Hard numbers, not extrapolation."""
import torch, sys
...
from phase5_orchestrator import moe_decode_full as _unused  # noqa
...
def main():
    torch.manual_seed(0)
    print("=== Phase 7 tiny: megakernel-full vs production aiter.fused_moe ===")
